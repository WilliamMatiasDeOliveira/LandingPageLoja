<style>
    ...
    <div class="container-fluid navigation">
        <div class="row">
            ...
            <div class="row d-none d-md-flex justify-content-end  align-items-center mt-1">
                <div class="col-auto text-info"data-aos="fade-right">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto text-center">
                <li class="nav-item d-lg-none">
                    <form action="{{route('logout')}}" method="post">
                        @csrf
                        <button type="submit"class="btn btn-danger btn-sm w-100 mb-2">SAIR</button>
                    </form>
                </li>
            </ul>
        </div>
